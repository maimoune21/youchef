                            ...
                            <div className="border-b-1 border-gray-400 py-2 sm:px-6">
                                <div className="grid grid-cols-1 sm:grid-cols-[5fr_0.5fr] gap-6">
                                    ...
                                    <div className="flexy sm:flex-col gap-4">
                                        <di className="flexy gap-2 py-2 w-36 bg-green-600 rounded-md cursor-pointer">
                                            <a href={`mailto:${user.email}`} className="text-white text-sm font-bold">
                                                Send Email
                                            </a>
                                        ...
                                        <span className="flexy bg-red-600 rounded-md py-1.5 w-36 cursor-pointer">
                                            <b className="text-sm text-white whitespace-nowrap">
                                                Delete
                                            </b>
                                            <TrashIcon size="size-6 text-white!" />
                                        </span>
                                    </div>
                                </div>
                            </div>

...
export default function Header() {
  ...
  const [userName, setUserName] = useState("btata");
    ...
    <>
      <div className="relative grid grid-cols-1 grid-rows-2 md:grid-rows-1 md:grid-cols-2 justify-center items-center w-[90%] md:w-[90%] lg:w-[90%] rounded-3xl custom-shadow -mt-5 mb-20 bg-30 min-h-fit md:min-h-[85vh] max-md:max-h-[232px]">
        ...
        <div className="absolute top-3 right-3 md:top-3 md:right-3 grid grid-cols-2 cursor-pointer! z-1">
          <ScrollLink to="ContectUs" smooth={true} duration={500} offset={-70}>
        ...
        <div className="z-10 flex flex-col gap-2 md:gap-10 justify-center max-md:items-center h-full w-full px-5 mt-20 py-10 md:pl-10 max-md:text-center">
          ...
          <p className="text-second text-xl md:text-lg sm:pr-16">
            Your way to discover variety of meals from different places cultures
        ...
        >
          ...
          <img
            ...
            style={{
              transform: `translate(${-smoothPos.x * 30}px, ${
                -smoothPos.y * 30
              }px)`,
            }}
          />

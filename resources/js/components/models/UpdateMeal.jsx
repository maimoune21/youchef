...
import { ChevronLeft, CirclePlus, CircleX, MoveLeftIcon } from "lucide-react";
                        ...
                        <form className="grid grid-cols-2 max-md:grid-cols-1 max-md:gap-2 gap-12">
                                ...
                                <div className="relative custom-shadow rounded-lg">
                                    ...
                                    >
                                        <img
                                            ...
                                            alt="meal"
                                        />
                                        <div className="absolute right-0 top-0 p-1 bg-30 text-black rounded-bl-lg rounded-tr-lg shadow-[-5px_5px_10px_hsla(0,0%,0%,0.2)]">
                                            <EditIcon />
                                        </div>
                                    </label>
                                </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <span className="flex flex-col gap-0.5">
                                            ...
                                            (ingredient, index) => (
                                                ...
                                                >
                                                    <span className="flexy gap-1 relative w-full">
                                                        ...
                                                        />
                                                        <CircleX
                                                            className="size-5 text-red-700 absolute right-2 cursor-pointer"
                                                            onClick={() =>
                                    ...
                                    <div
                                        className="flexy gap-1 mt-1.5 cursor-pointer"

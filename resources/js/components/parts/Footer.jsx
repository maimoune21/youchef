    ...
    <div className="hidden md:block mt-25">
      ...
      <footer className="bg-10 pb-10 pt-16 px-6 md:px-12 overflow-hidden">
        <div className="max-w-7xl mx-auto h-64">
          <div className="grid grid-cols-1 md:grid-cols-[30%_1fr] gap-12 md:text-center text-left links-container">
            {/* Logo Section */}
              ...
              <div className="space-y-4 align-self-end flexy flex-col gap-6 mr-15 socials">
                ...
                <ul className="space-y-2">
                  <div className="flex space-x-4 justify-center sm:justify-start">
                    <a aria-label="Instagram" className="SocialIcons">
                      <InstagramIcon />
                    </a>
                    <a aria-label="Facebook" className="SocialIcons">
                      <FacebookIcon />
                    </a>
                    <a aria-label="Twitter" className="SocialIcons">
                      <TwitterIcon />
                    </a>
                    <a aria-label="YouTube" className="SocialIcons">
                      <YouTubeIcon />
                    </a>
                  </div>
                </ul>
          ...
          {/* Footer Bottom */}
          <div className="border-t-1 border-black mt-4 ml-16 max-lg:ml-0 pt-2.5 text-sm text-first grid grid-cols-2 z-[999]">
            <span></span>
            <strong className="text-base ml-2">
              <b>&copy;</b> {new Date().getFullYear()} YouChef. All rights
              reserved.
            </strong>
          </div>
        </div>
